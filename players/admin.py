...
class PlayersAdmin(admin.ModelAdmin):
    list_display = ('name', 'club_name', 'phone_numper', 'email', 'date_from_year', 'date_to_year')  # الحقول التي ستظهر في القائمة
    ...
    fieldsets = (
        ...
        ('Academy Data', {
         ...
         ('School Data', {
            'fields': ('school_name', 'date_from_school', 'date_to_scshool', 'description_school')
        }),
